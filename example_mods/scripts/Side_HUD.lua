notehitlol = 0
sadfasd = 0 -- unused
font = "comic.ttf" -- the font that the text will use.
cmoffset = -4
cmy = 20
tnhx = -10
spacing = 15
function onCreate()
    ...
    makeLuaText("sick", 'Sicks!: 0', 200, getProperty('cm.x'), getProperty('cm.y') + spacing);
    makeLuaText("good", 'Goods: 0', 200, getProperty('cm.x'), getProperty('sick.y') + spacing);
    makeLuaText("bad", 'Bads: 0', 200, getProperty('cm.x'), getProperty('good.y') + spacing);
    makeLuaText("shit", 'Shits: 0', 200, getProperty('cm.x'), getProperty('bad.y') + spacing);
    makeLuaText("miss", 'Misses: 0', 200, getProperty('cm.x'), getProperty('shit.y') + spacing);
